...
<body>
   ...
   <p class="fs-1 ali text-center py-5">Modificar trabajo de grado</p> 
    ...
    <form action="" method="post">
		<div class="row align-items-start px-5 mx-5">
			...
			<div class="input-group mb-3">
				...
				<input type="text" class="form-control" placeholder="Modifica aqui el nombre de la propuesta" aria-label="Username" aria-describedby="basic-addon1">
			</div>
			</div>
			<div class="col-5">
...
<br>
<br>
    <div class="container-fluid bg-dark text-center p-3 text-light ">
        <p class="small">&copy; Todos los derechos reservados. Webtesis</p>
