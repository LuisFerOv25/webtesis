...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="fs-1 text text-dark text-center py-5">
        Trabajo de grado
      </div>
    </div>
...
while($row=mysqli_fetch_array($query)) {
  ...
  ?>
     <tr>
      ...
      <th><a href="trabajoG.php?id=<?php echo $row['idTrabajoGrado'] ?>" class="btn btn-info">Editar</a></th>
...
?>
  ...
  <div class="container-fluid bg-dark text-center p-5 text-light ">
