...
$querybuscar = mysqli_query($con, "SELECT * FROM persona JOIN estudiante ON persona.idpersona=estudiante.idpersona WHERE estudiante.idpersona=$result[0]");
            ...
            <div class="row align-items-start">
              ...
              <div class="col">
                <div class="input-group input-group-sm mb-3">
                  ...
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="txtcodest" value="<?php echo $codest ?>" required disabled>
                </div>
              ...
              <div class="col">
                <div class="input-group input-group-sm mb-3">
                  ...
                  <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="txtsemes" value="<?php echo $semestre; ?>" required disabled>
                </div>
