      ...
      ?>
        ...
        ?>
          ...
          $query_insert_persona = mysqli_query(conexion(), "INSERT INTO persona(nombre,apellido,tipoide,numdoc,celular,correo,pass,sexo,idrol)
							 VALUES ('$nombre','$apellido','$tipoide','$numdoc','$celular','$correo','$pass','$sexo',3)");
          ...
          $query_insert_estudiante = mysqli_query(conexion(), "INSERT INTO estudiante(codigoestudiante,semestre,idpersona) VALUES ($codigoestudiante,'$semestre',$result3[0])");
              ...
              <form action="" method="post">
                ...
                <div class="row ">
                  <div class="col mx-5 px-5">
                    ...
                    <label for="codigoestudiante" class=" col-form-label">Código Estudiantil</label>
                  ...
                  <div class="col mx-5 px-5">
                    <label for="semestre" class=" col-form-label">Semestre actual</label>
                    <div class="col-md-auto">
                ...
                <div class="row ">
                  ...
                  <div class="col mx-5 px-5">
                    <label for="confpass" class="col-form-label"> Confirmar contraseña </label>
                    <div class="col-sm-auto">
