...
if (!empty($_POST)) {
	$alert = '';
	if (empty(empty($_POST['codigoestudiante']) || empty($_POST['semestre']) || $_POST['nombre']) || empty($_POST['apellido']) || empty($_POST['tipoide']) || empty($_POST['numdoc']) || empty($_POST['sexo']) || empty($_POST['celular']) || empty($_POST['correo']) || empty($_POST['pass'])) {
		...
		if ($_POST['pass'] != $_POST['confpass']) {
			...
			if ($_POST['correo'] != $_POST['confcorreo']) {
				...
				if ($result > 0) {
					...
					$query_insert_estudiante = mysqli_query($conn, "INSERT INTO estudiante(codigoestudiante,semestre,idpersona) VALUES ($codigoestudiante,'$semestre',$result3[0])");
	...
	<div class="form_registro">
		...
		<form action="" method="post">
			...
			<div class="container border border-success bg-success p-2 text-dark bg-opacity-50 mx-auto" style="width: 850px;">
				...
				<div class="row mb-3">
					<label for="codigoestudiante" class="col-sm-2 col-form-label">Código Estudiante:</label>
				...
				<div class="row mb-3">
					<label for="semestre" class="col-sm-2 col-form-label">semestre Estudiante:</label>
					<div class="col-md-auto">
