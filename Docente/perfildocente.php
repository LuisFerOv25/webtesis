        ...
        <div class="container text-right">
          ...
          <div class="row align-items-start">
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-sm" name="txtrol" value="<?php 
                if ($idrol == 1){
                    echo ("Jurado");
                }else if($idrol == 2){
                    echo ("Asesor");
            ...
            <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-sm" name="txtespe" value="<?php echo $especialidad;?>" required>
            </div>
...
{    
  ...
  if($querymodificar_doc){
    ...
    <script> alert("Error al modificar los datos") </script>
    <?php
  }
